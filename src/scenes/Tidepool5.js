class TidePool5 extends Phaser.Scene{
    ...
    create(){
        ...
        //load in animals
        this.animal1 = new AquaAnimal(this, this.value1, 50, 'star').setScale(2).setInteractive()
        this.animal2 = new AquaAnimal(this, this.value2, 150, 'fish').setScale(5).setInteractive()
