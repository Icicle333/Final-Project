class TidePool7 extends Phaser.Scene{
    ...
    create(){
        ...
        //Creates random x values for animals
        this.value1 = Phaser.Math.Between(300, 400)
        this.value2 = Phaser.Math.Between(100, 200)
        this.value3 = Phaser.Math.Between(500, 600)
        //Loads in animals
        this.animal1 = new AquaAnimal(this, this.value3, 50, 'mussel').setScale(2).setInteractive()
        this.animal1.setTint(0x4E3B31)
        this.animal2 = new AquaAnimal(this, this.value1, 150, 'mussel').setScale(5).setInteractive()
